  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-[80px] md:top-[100px] flex flex-col items-start px-4 sm:px-5 md:px-8 text-white ml-0 md:ml-8 z-10">
          <h1 className="text-[36px] sm:text-[48px] md:text-[72px] lg:text-[120px] leading-[40px] sm:leading-[50px] md:leading-[80px] lg:leading-[115px] font-san max-w-full md:max-w-3xl mt-4">
            I am a Sample Website
          </h1>
          <p className="text-[16px] sm:text-[18px] md:text-[28px] lg:text-[42px] leading-[20px] sm:leading-[22px] md:leading-[38px] lg:leading-[45px] mt-4 md:mt-6 w-full sm:w-[300px] md:w-[400px] font-sans font-normal mb-6 md:mb-10 p-2 sm:p-3">
